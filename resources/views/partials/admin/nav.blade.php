    ...
    <div class="container is-fluid">
        ...
        <div class="navbar-menu">
            <div class="navbar-start">
                ...
                @include('partials.admin.nav.single', ['resource' => 'service', 'text' => 'Services', 'icon' => 'user'])
                @include('partials.admin.nav.single', ['resource' => 'slider', 'text' => 'Sliders', 'icon' => 'film'])
                @include('partials.admin.nav.single', ['resource' => 'section', 'text' => 'Sections', 'icon' => 'camera'])
                @include('partials.admin.nav.single', ['resource' => 'message', 'text' => 'Feedbacks', 'icon' => 'box'])
                @include('partials.admin.nav.single', ['resource' => 'request', 'text' => 'Request', 'icon' => 'book'])
